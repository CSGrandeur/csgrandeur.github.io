const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/md-p3vp6_c-.js","assets/modules/shiki-DeTF74yl.js","assets/rolldown-runtime-hePW80VL.js","assets/modules/shiki-BrmBd2_v.css","assets/slidev/context-CFZR7p0y.js","assets/modules/vue-CGb69BCx.js","assets/md-DwhzYGEu.js","assets/slidev/SlideChrome-Cu1tEqzH.js","assets/syncState-CQbDxmWp.js","assets/index-Bij0zZ2n.js","assets/index-8dE_dpr8.css","assets/useDrawings-BIgoI0JD.js","assets/ItemList-Cv-ZtB_K.js","assets/md-C__4iV55.js","assets/lesson-cards-MI1XPM9_.js","assets/md-BTfkaIf_.js","assets/lesson-compare-3V3CqPjC.js","assets/md-Dg9ChrSL.js","assets/lesson-steps-CbZYsh8d.js","assets/md-ZWnbAmAy.js","assets/md-2_OZ0IlY.js","assets/md-C6Z8DRuB.js","assets/md-CuUYs-BE.js","assets/md-B8uzKZ2L.js","assets/md-BNHXSjcj.js","assets/md-Dg7NeYgb.js","assets/md-CawlOYj3.js","assets/md-Xw1Z_2hx.js","assets/md-CoMhXP_K.js"])))=>i.map(i=>d[i]);
...
`,note:``,title:`常见问题`,level:1,index:13,noteHTML:``,images:[],raw:``,frontmatter:U,filepath:``,start:339,sourceIndex:13,id:13,no:14},__clicksContext:null,__preloaded:!1}),W=u({layout:`lesson-accept`,week:0,weekLabel:`课前`,spine:[`课程`,`基本功`,`判断力`,`自检`],heading:`课前完成`,kicker:`0.13　上课前`,nav:3,deliverable:[`读完本节，能说明本课做什么：用助手做出校园应用`,`实验环境能打开，命令能跑通一条`,`带着选题方向来上课`],criteria:[`知道盲打、编辑器、Git、Markdown 各做什么`,`不把课外竞赛当成必须提交`],due:`上课前　·　不计入七次小报告`,stat:`课前`,statLead:`平时从正式上课起算；本次只做准备`}),tt=g({get layout(){return W.layout},get transition(){return W.transition},get class(){return W.class},get clicks(){return W.clicks},get name(){return W.name},get preload(){return W.preload},slide:{content:``,revision:`vrpe3m`,frontmatterRaw:`layout: "lesson-accept"
week: 0
weekLabel: "课前"
spine:
  - "课程"
